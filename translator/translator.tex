...
{\colorbox{MyHighlight}{Bachelor of Computer Science (Honours) in Software Engineering}; CGPA:3.9744}{Oct 2019 -- Oct 2022}
% \begin{spacing}{0.4}
%   \colorbox{yellow}{\it\footnotesize CGPA: 3.9744}
% \end{spacing}
\resumeSubSubheading{Foundation in Science; CGPA: 4.0000}{Sep 2018 -- Sep 2019}
\resumeItemListStart
\resumeItem{Skills Acquired}{\CC, C\mytextsharp, Java, Python, ASP.NET, SQL, HTML/CSS/Javascript}
...
{Machine Learning Intern}{June 2022 -- present}
\resumeItemListStart
\resumeItem{\colorbox{MyHighlight}{Academic Research}}
{Reading through journal papers on speech recognition to aid in model implementation}
\resumeItem{Model Implementation}
{Exploring HuggingFace library and OpenSpeech framework}
\resumeItemListEnd
...
{\colorbox{MyHighlight}{Chinese-English Translator-cum-Proofreader}}{May 2020 -- Nov 2021}
\resumeItemListStart
...
\resumeItemListStart
\resumeItem{\colorbox{MyHighlight}{Research and Implementation}}{Read through 20+ journal papers and applied 3 abstractive summarisation algorithms}
